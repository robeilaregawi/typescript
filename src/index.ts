...
function render(documemt: string) {
    console.log(documemt);
}
...
let user: [number, string] = [1, 'Robeil'];

function renderUser(user: [number, string]) {
    console.log(user);
}
enum Size {
    Small = 'small',
...
//         return weight * 2.2;
//     else
//         return weight.parseInt(weight) * 0.2;
// }
...
type UIWedget = Dragable & Resizable;
...
let custommer = getCustomer(0);
// if(custommer)
console.log('custommer.birthday ' + custommer?.birthday);